...
void ClapTrap::attack(const std::string &target)
{
	...
	{
		std::cout << "ClapTrap " << this->get_name() << " has no hitPoints to attack!" << std::endl;
	}
	else
	{
...
void ClapTrap::takeDamage(unsigned int amount)
{
	...
	{
		std::cout << "ClapTrap " << this->get_name() << " takes " << amount << " of damage" << std::endl;
		if (hitPoints >= amount)
			hitPoints -= amount;
		else
			hitPoints = 0;
...
void	ClapTrap::beRepaired(unsigned int amount)
{
	...
	if (energyPoints == 0)
	{
		std::cout << "ClapTrap " << this->get_name() << " has no energy to repair itself!" << std::endl;
	}
	else if (hitPoints == 0)
	{
	...
	{
		std::cout << "ClapTrap " << this->get_name() << " reapairs itself " << amount << " hitpoint" << std::endl;
		hitPoints += amount;
		energyPoints--;
		std::cout << "Now he have " << hitPoints << " hitPoint" << std::endl;
	}
